...
{
    /// <summary>
    /// Contains tests for both the RegisterUser and LoginUser MediatR command handlers.
    /// </summary>
    public class UserCommandTests
    {
        ...
        public class RegisterUserTests
        {
            ...
            {
                // Provide a dummy IUserStore<User> and null for other dependencies
            ...
            public async Task Handle_WhenCreateSucceeds_ReturnsUserIdAsString()
            {
                ...
                // When CreateAsync is called, return success and assign our known GUID in a callback
                _mockUserManager
